...
#ifndef LOOP_ACIS_HPP
#define LOOP_ACIS_HPP
...
class LoopACIS : public LoopSM, public AcisBridge
{
public:
  
  LoopACIS(LOOP* LOOPPtr = NULL);
    //- A constructor with a pointer to a ACIS LOOP.
  
  virtual ~LoopACIS() ;
    //- The destructor.

  LOOP* get_LOOP_ptr() const;
  void set_LOOP_ptr(LOOP* LOOP_ptr);
