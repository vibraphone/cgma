...
#ifndef COEDGE_ACIS_HPP
#define COEDGE_ACIS_HPP
...
class CoEdgeACIS : public CoEdgeSM, public AcisBridge
{
public:
  
  CoEdgeACIS(COEDGE* COEDGEPtr = NULL);
    //- A constructor with a pointer to a ACIS COEDGE.
  
  virtual ~CoEdgeACIS() ;
    //- The destructor
  
  COEDGE* get_COEDGE_ptr() const;
  void set_COEDGE_ptr(COEDGE* COEDGE_ptr);
