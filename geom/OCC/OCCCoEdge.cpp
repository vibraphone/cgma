...
void OCCCoEdge::append_simple_attribute_virt(const CubitSimpleAttrib& csattrib_ptr)
{
}

void OCCCoEdge::remove_simple_attribute_virt(const CubitSimpleAttrib& csattrib_ptr)
{
}
