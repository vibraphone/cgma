...
class CUBIT_GEOM_EXPORT GfxPreview
{
  ...
  protected:
    ...
    virtual void p_draw_frustum(const CubitVector axis, const CubitVector origin1, const CubitVector origin2, 
                                  double radius1 , double radius2 ,CubitBox bounding_box , int color) = 0;
