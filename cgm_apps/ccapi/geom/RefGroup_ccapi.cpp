#include "RefGroup_ccapi.h"

#include "RefGroup.hpp"
#include "RefEntity.hpp"
#include "DLRefEntityList.hpp"
#include "DLRefGroupList.hpp"
...
{
  RefGroup *temp_group = (RefGroup *) this_group;
  return temp_group->maximum_dimension();
}
...
{
  RefGroup *temp_group = (RefGroup *) this_group;
  RefEntity *temp_ref_entity = (RefEntity *) ref_entity;
  
  return temp_group->add_ref_entity(temp_ref_entity);
}
                                           ...
                                           int *entity_list_size)
{
  ...
  return temp_group->add_ref_entity(temp_entity_list);
}
                                            ...
                                            const enum CubitBoolean from_observable)
{
  ...
  return temp_group->remove_ref_entity(temp_ref_entity);
}
                               ...
                               int *entity_list_size)
{
  ...
  temp_group->get_sub_entities(temp_entity_list);
...
{
  RefGroup *temp_group = (RefGroup *) this_group;
  return temp_group->is_mergeable();
}
...
{
  RefGroup *temp_group = (RefGroup *) this_group;
  return temp_group->remove_all_ref_entities();
}
                                     ...
                                     int *entity_list_size)
{
  ...
  temp_group->get_child_ref_entities(temp_entity_list);
...
{
  RefGroup *temp_group = (RefGroup *) this_group;
  DLCubitEntityList temp_cub_entity_list;
  
  temp_group->get_child_entities(temp_cub_entity_list);

  COPY_LIST_TO_ARRAY(temp_cub_entity_list, *cub_entity_list, *cub_entity_list_size);
}
                           ...
                           int *entity_list_size)
{
  ...
  temp_group->expand_group(temp_entity_list);
...
{
  RefGroup *temp_group = (RefGroup *) this_group;
  return temp_group->bounding_box();
}
...
{
  RefGroup *temp_group = (RefGroup *) this_group;
  return temp_group->center_point();
}
...
{
  RefGroup *temp_group = (RefGroup *) this_group;
  return temp_group->get_address(inputEntityType);
}
...
{
  RefGroup *temp_group = (RefGroup *) this_group;
  RefGroup *temp_group_to_subtract = (RefGroup *) group_to_subtract;
  RefGroup *temp_target_group = (RefGroup *) target_group;
  
  return temp_group->subtract(temp_group_to_subtract, temp_target_group);
}
...
{
  RefGroup *temp_group = (RefGroup *) this_group;
  RefGroup *temp_other_group = (RefGroup *) other_group;
  RefGroup *temp_target_group = (RefGroup *) target_group;
  
  return temp_group->intersect(temp_other_group, temp_target_group);
}
                     ...
                     /* RefGroup * */ void *target_group)
{
  ...
  return temp_group->unite(temp_other_group, temp_target_group);
}
...
{
  RefGroup *temp_group = (RefGroup *) this_group;
  RefGroup *temp_group_ptr = (RefGroup *) group_ptr;
  
  return temp_group->delete_group (temp_group_ptr, propagate);
}
...
void RefGroup_delete_all_groups (void *)
{
...
void RefGroup_get_contained_groups (void *,
                                      /* RefGroup * */ void *group_ptr,
                                      /* DLRefGroupList & */ void ***contained_groups,
                                    int *contained_groups_size)
{
  DLRefGroupList temp_contained_groups;
  RefGroup *temp_group_ptr = (RefGroup *) group_ptr;
  
  RefGroup::get_contained_groups (temp_group_ptr, temp_contained_groups);

  COPY_LIST_TO_ARRAY(temp_contained_groups, *contained_groups, *contained_groups_size);
}
...
void RefGroup_get_groups_within_1(void *,
...
{
  DLRefGroupList temp_groups_within;
  CubitEntity *temp_cubit_entity_ptr = (CubitEntity*) cubit_entity_ptr;
  
  RefGroup::get_groups_within(temp_cubit_entity_ptr, temp_groups_within,
                                recursive);

  COPY_LIST_TO_ARRAY(temp_groups_within, *groups_within, *groups_within_size);
}

void RefGroup_get_groups_within_2(void *,
                                  ...
                                  const enum CubitBoolean recursive)
{
  ...
  RefGroup::get_groups_within(temp_ref_entity_ptr, temp_groups_within,
                                recursive);

  COPY_LIST_TO_ARRAY(temp_groups_within, *groups_within, *groups_within_size);
}

void RefGroup_get_groups_within_3(void *,
...
{
  DLRefGroupList temp_groups_within;
  RefGroup *temp_ref_group_ptr = (RefGroup*) ref_group_ptr;
  
  RefGroup::get_groups_within(temp_ref_group_ptr, temp_groups_within, recursive);
                                          ...
                                          enum CubitBoolean from_observable)
{
  ...
  return temp_group->notify_observer(temp_observable, *temp_observer_event, from_observable);
}
