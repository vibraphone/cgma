#ifndef REFVOLUME_CCAPI_HPP
#define REFVOLUME_CCAPI_HPP
...
extern "C" {
  ...
  enum EntityType RefVolume_get_grouping_entity_type();
  ...
  enum EntityType RefVolume_get_sense_entity_type();
...
/* Lump* */ void * RefVolume_get_lump_ptr() ;
    /* R Lump* */
...
struct CubitVectorStruct RefVolume_center_point();
    /* - Returns centroid of the RefVolume */
  
/* **********Graphics Related Functions********** */
int RefVolume_dimension(); 
    /* - returns dimension of the actual entity.  */

    /* other functions */

enum EntityType RefVolume_entity_type();

void * RefVolume_get_address(enum EntityType inputEntityType);
    /* R void * */
...
/* CubitString */ const char *RefVolume_measure_label();

void RefVolume_draw_my_faces(int color);
